...
BEGIN
	...
	IF EXISTS (SELECT 1 FROM [output].[ClusterMembership])
	BEGIN
		PRINT 'Skipping, candidates already populated'
	END
	ELSE
	BEGIN
		...
		exec CreateDummyCandidate '1CFG7788V','Diana','Lance','27/10/1953 00:00','A9649AA','B004219','TRUE','Male','British','White','NOMIS','SFI','C11';
		...
		exec CreateDummyCandidate '1CFG6849L','Bruce','Parker','20/02/1977 00:00','A7483AA','B009597','TRUE','Male','British','White','DELIUS','NLI','NBR';
