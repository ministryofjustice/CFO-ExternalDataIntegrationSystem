CREATE FUNCTION [DeliusStaging].[Fn.StandardiseEthnicity] (@ethnicity nvarchar(100))
...
begin
	...
	from 
		...
		[DeliusStaging].[Lookups.EthnicityStandard]
	where 
		[EthnicityID] = (select [EthnicityID] from [DeliusStaging].[Lookups.Ethnicity] where [SourceEthnicity] = @ethnicity)
