...
public abstract class FileSource
{
    ...
    /// </summary>
    public abstract Task<IReadOnlyList<string>> ListOfflocFilesAsync(CancellationToken cancellationToken = default);

    /// <summary>
    /// Returns a collection of Delius files (including their paths and extensions) from the file source.
    /// </summary>
    public abstract Task<IReadOnlyList<string>> ListDeliusFilesAsync(CancellationToken cancellationToken = default);
